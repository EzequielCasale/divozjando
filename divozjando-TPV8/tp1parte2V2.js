// sketch.js - Principal, obra sin tests de visualización de brillo cálido/frío
...
// AGREGADO: para opacidad de líneas según movimiento
let prevVOffset = 0;
let prevHOffset = 0;
...
function preload() {
  imgPalette = loadImage('imagenes/Obra.png'); // Cambia por tu archivo de imagen
...
function draw() {
  background(50, 25, 98); // amarillo pálido
  ...
  // --- Opacidad variable para líneas negras según movimiento ---
  ...
  for (let b of brushes) b.draw(illumCalido, illumFrio); // PASAMOS FACTORES DE LUMINOSIDAD
}
