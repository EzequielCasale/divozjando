...
function setup() {
  ...
  // Precalcula las manchas frias-calidas
...
function generarLineas() {
  ...
  for (let r of rects) {
    let lados = [
      [[r.x, r.y], [r.x + r.w, r.y]],             // arriba hor
      [[r.x + r.w, r.y], [r.x + r.w, r.y + r.h]], // derecha ver
      [[r.x + r.w, r.y + r.h], [r.x, r.y + r.h]], // abajo hor
      [[r.x, r.y + r.h], [r.x, r.y]],             // izquierda ver
    ];
...
// Pinceladas los colorea cuando cambia el brillo
